...
export default function FlightCard({ flight }: any) {
  return (
    <div className="mb-2 flex flex-col gap-4 rounded-lg border border-white/30 bg-gray-100/95 backdrop-blur-md p-4 shadow-sm transition hover:shadow-md sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex flex-1 items-center justify-between gap-6 text-sm text-gray-700 sm:px-6">
        ...
        <div className="text-center flex flex-col gap-2">
         ...
         <div className="text-center flex flex-col gap-2">
          <p className="text-xs md:text-sm font-semibold uppercase text-black">Stops</p>
